...
{
	Macro_Write_Block(ADC1->SQR3, 0x1F, ch, 0); 	// Sequence Channel of No 1 = ch
}
...
{
	ADC1_Select_Channel(ch);
	ADC1_Start();
	while(!ADC1_Get_Status());
	return ADC1_Get_Data();
}
